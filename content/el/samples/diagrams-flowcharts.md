...
Refer to the [mermaid shortcode]({{< ref "posts/shortcodes#mermaid" >}}) posts for more details.

The examples below are a small selection taken from the [official Mermaid posts](https://mermaid-js.github.io/mermaid/). You can also [view the page source](https://raw.githubusercontent.com/jpanther/congo/dev/exampleSite/content/samples/diagrams-flowcharts.md) on GitHub to see the markup.
