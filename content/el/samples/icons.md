...
Congo has built-in support for a number of [FontAwesome 6](https://fontawesome.com/icons) icons. These can be included in your website through either the [icon partial]({{< ref "posts/partials#icon" >}}) or [icon shortcode]({{< ref "posts/shortcodes#icon" >}}).
