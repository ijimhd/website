...
Refer to the [chart shortcode]({{< ref "posts/shortcodes#chart" >}}) posts for more details.

The examples below are a small selection taken from the [official Chart.js posts](https://www.chartjs.org/posts/latest/samples). You can also [view the page source](https://raw.githubusercontent.com/jpanther/congo/dev/exampleSite/content/samples/charts.md) on GitHub to see the markup.
