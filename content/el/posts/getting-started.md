...
tags: ["installation", "posts"]
---

{{< alert >}}
This section assumes you have already [installed the Congo theme]({{< ref "posts/installation" >}}).
{{< /alert >}}
...
Congo defines a three-colour palette that is used throughout the theme. Each main colour contains ten shades which are based upon the colours that are included in [Tailwind](https://tailwindcss.com/posts/customizing-colors#color-palette-reference).
...
It's important to have a firm grasp of how Hugo expects content to be organised as the theme is designed to take full advantage of Hugo page bundles. Be sure to read the [official Hugo posts](https://gohugo.io/content-management/organization/) for more information.
...
This will replace the default _tags_ and _categories_ with _topics_. Refer to the [Hugo Taxonomy posts](https://gohugo.io/content-management/taxonomies/) for more information on naming taxonomies.
